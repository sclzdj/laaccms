...
@section('content')
    @component('components.tabls')
        ...
        @slot('nav')
            ...
            <li class="nav-item">
                <a class="nav-link active" href="/article/content/create">添加文章</a>
            </li>
        @endslot
        @slot('body')
            <form action="/article/content" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="title" value="{{old('title')}}" placeholder="文章标题">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="author" value="{{old('author')}}" placeholder="作者">
                    <small class="form-text text-muted">长度1-100位</small>
                </div>
                <div class="form-group">
                    <label style="display: block;">缩略图</label>
                    <hd-image name="thumb" image-url="{{old('thumb')}}" allow-szie="3"></hd-image>
                ...
                <div class="form-group">
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="is_top1" name="is_top" value="1" class="custom-control-input">
                        <label class="custom-control-label" for="is_top1">是</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="is_top2" name="is_top" value="0" checked class="custom-control-input">
