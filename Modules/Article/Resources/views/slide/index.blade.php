    ...
    <div class="card" id="app">
        ...
        <div class="tab-container">
            <ul role="tablist" class="nav nav-tabs">
                <li class="nav-item"><a href="/article/slide" class="nav-link active">轮播图列表</a></li>
                <li class="nav-item"><a href="/article/slide/create" class="nav-link">添加轮播图</a></li>
            </ul>
                    ...
                    <table class="table">
                        ...
                        @foreach($data as $d)
                            <tr>
                                ...
                                <td>{!! $d['title'] !!}</td>
                                <td>{!! $d['url'] !!}</td>
                                <td><img src='{!! $d['pic'] !!}' style='width:45px;height:45px;'/></td>
                                <td>{!! $d['status']?'开启':'关闭' !!}</td>
                                <td>{!! $d['created_at'] !!}</td>
                                <td>{!! $d['updated_at'] !!}</td>
                                <td class="text-right">
